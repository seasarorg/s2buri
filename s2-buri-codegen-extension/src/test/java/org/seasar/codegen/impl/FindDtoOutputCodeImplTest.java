...
public class FindDtoOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/FindDtoOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public FindDtoOutputCodeImplTest(String arg0) {
        super(arg0);
    }
