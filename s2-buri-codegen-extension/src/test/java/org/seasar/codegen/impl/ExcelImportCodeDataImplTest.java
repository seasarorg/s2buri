...
/**
 * ExcelImportCodeDataImpl の単体テスト。
 * 
 * @author glad
 */
public class ExcelImportCodeDataImplTest extends S2TestCase {

    private ExcelImportCodeDataImpl importCodeData;
    
    protected void setUp() throws Exception {
        include("ExcelImportCodeDataImplTest.dicon");
    }

    public void testReadCodeData() {
        File src = new File("test/CodeGen-Example.xls");
