...
public class FindPackSQLOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/FindPackSqlOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public FindPackSQLOutputCodeImplTest(String arg0) {
        super(arg0);
    }
