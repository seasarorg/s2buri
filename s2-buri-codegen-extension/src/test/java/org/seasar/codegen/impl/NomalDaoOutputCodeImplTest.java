...
public class NomalDaoOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/NomalDaoOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public NomalDaoOutputCodeImplTest(String arg0) {
        super(arg0);
    }
