...
public class PackDaoOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/PackDaoOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public PackDaoOutputCodeImplTest(String arg0) {
        super(arg0);
    }
