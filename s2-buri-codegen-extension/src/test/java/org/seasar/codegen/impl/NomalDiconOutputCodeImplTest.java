...
public class NomalDiconOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/NomalDiconOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public NomalDiconOutputCodeImplTest(String arg0) {
        super(arg0);
    }
