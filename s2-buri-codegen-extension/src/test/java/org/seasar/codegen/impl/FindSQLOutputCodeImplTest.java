...
public class FindSQLOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/FindSqlOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public FindSQLOutputCodeImplTest(String arg0) {
        super(arg0);
    }
