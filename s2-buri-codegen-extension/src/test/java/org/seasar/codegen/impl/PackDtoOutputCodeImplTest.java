...
public class PackDtoOutputCodeImplTest extends S2TestCase {
    private String PATH = "org/seasar/codegen/impl/PackDtoOutputCode.dicon";

    private ImportCodeData importCodeData_;

    private OutputCode outputCode_;

    public PackDtoOutputCodeImplTest(String arg0) {
        super(arg0);
    }
