...
public class KtHoliday {
        ...
        switch (MyMonth) {
            ...
            case 5:
                switch (MyDay) {
                    ...
                    case 6: // ５月６日
                        if (MyYear >= 2007) {
                            if ((MyDate.get(Calendar.DAY_OF_WEEK) == Calendar.TUESDAY) || (MyDate.get(Calendar.DAY_OF_WEEK) == Calendar.WEDNESDAY)) {
    ...
    private static int prvDayOfSpringEquinox(int MyYear) {
        ...
        if (MyYear <= 1947) {
            ...
            if (MyYear <= 1979) {
                SpringEquinox_ret = (int) (20.8357 + (0.242194 * (MyYear - 1980)) - ((MyYear - 1983) / 4));
            } else {
                if (MyYear <= 2099) {
                    SpringEquinox_ret = (int) (20.8431 + (0.242194 * (MyYear - 1980)) - ((MyYear - 1980) / 4));
                } else {
                    if (MyYear <= 2150) {
                        SpringEquinox_ret = (int) (21.851 + (0.242194 * (MyYear - 1980)) - ((MyYear - 1980) / 4));
                    } else {
    ...
    private static int prvDayOfAutumnEquinox(int MyYear) {
        ...
        if (MyYear <= 1947) {
            ...
            if (MyYear <= 1979) {
                AutumnEquinox_ret = (int) (23.2588 + (0.242194 * (MyYear - 1980)) - ((MyYear - 1983) / 4));
            } else {
                if (MyYear <= 2099) {
                    AutumnEquinox_ret = (int) (23.2488 + (0.242194 * (MyYear - 1980)) - ((MyYear - 1980) / 4));
                } else {
                    if (MyYear <= 2150) {
                        AutumnEquinox_ret = (int) (24.2488 + (0.242194 * (MyYear - 1980)) - ((MyYear - 1980) / 4));
                    } else {
