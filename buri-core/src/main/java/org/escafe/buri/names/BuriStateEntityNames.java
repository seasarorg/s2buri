...
/**
 * {@link BuriStateEntity}のプロパティ名の集合です。
 * 
 * @author S2JDBC-Gen
 * @suppresshack com.google.code.hack.ej2.ToStringRewriter
 */
public final class BuriStateEntityNames {

	private BuriStateEntityNames() {
    ...
    /**
     * participantNameのプロパティ名を返します。
     * 
     * @return participantNameのプロパティ名
     */
    public static PropertyName<String> participantName() {
        return new PropertyName<String>("participantName");
    }

    /**
     * participantTypeのプロパティ名を返します。
     * 
     * @return participantTypeのプロパティ名
     */
    public static PropertyName<String> participantType() {
        return new PropertyName<String>("participantType");
    }
     ...
     * @suppresshack com.google.code.hack.ej2.ToStringRewriter
     */
    public static class _BuriStateEntityNames extends PropertyName<BuriStateEntity> {

        /**
         * インスタンスを構築します。
         */
        public _BuriStateEntityNames() {
        }
         ...
         *            名前
         */
        public _BuriStateEntityNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _BuriStateEntityNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return participantNameのプロパティ名
         */
        public PropertyName<String> participantName() {
            return new PropertyName<String>(this, "participantName");
        }
         ...
         * @return participantTypeのプロパティ名
         */
        public PropertyName<String> participantType() {
            return new PropertyName<String>(this, "participantType");
        }
