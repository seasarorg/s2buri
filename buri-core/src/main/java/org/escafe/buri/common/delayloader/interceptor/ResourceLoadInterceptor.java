...
import org.escafe.buri.common.delayloader.DelayLoaderInfo;
import org.escafe.buri.common.util.ScriptProcessor;
import org.seasar.framework.aop.interceptors.AbstractInterceptor;
import org.seasar.framework.container.S2Container;
import org.seasar.framework.util.StringUtil;

public class ResourceLoadInterceptor extends AbstractInterceptor {
    private int keyNo = 0;
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        loader.addResourceLoader(invocation.getThis(), info);
