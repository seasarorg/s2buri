 ...
 * <p>
 * プロセッサからエンジンに制御を委譲する際に、引き渡すデータを格納します。
 * 使用するS2コンテナ、トランジションに使用する{@code action}、
 * {@code toNextStatus}の戻り値を作成する為のOGNL式と
 * 権限主体を適用した場合のアクティビティ名のリストを設定する事ができます。
 * </p>
 * 
 * @author makotan
 * @author nobeans
