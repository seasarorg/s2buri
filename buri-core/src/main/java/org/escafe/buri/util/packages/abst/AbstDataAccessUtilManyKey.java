...
public abstract class AbstDataAccessUtilManyKey extends AbstDataAccessUtil
        implements DataAccessUtilManyKey {
	...
	protected boolean hasPkey(Object data, String conditions[]) {
		...
		for (String condition : conditions) {
			Object evalResult =
			    pkeyExpressionScript.eval(data, condition, null);
