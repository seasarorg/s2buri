 ...
 * そして、ぶりはここに指定された日時にそのアクティビティ上のデータを自動的に実行します。
 * ただしその実行をぶりに指示する為に{@link BuriTimerService}を使用する必要があります。
 * この{@link BuriTimerService}の設定は、
 * 開発者が定義する{@code buri/dicon/buriTimer.dicon}にて行います。
 * </p>
 * <p>
 * この{@code Limit}のスキーマは、以下のように定義されています。
 * <pre>{@code  <xsd:element name="Limit">
 *     <xsd:complexType>
 *         <xsd:simpleContent>
