...
public class OouoClassDefImpl implements OouoClassDef {
	 ...
	 * 子要素を取得する為のセッターメソッド
	 */
	private final Map<String, Method> childElement =
	 ...
	 * </p>
	 */
	private final Map<String, Map<String, Method>> attriElement =
	    new HashMap<String, Map<String, Method>>();

	/**
	 * 要素とそれへの参照となるメソッドを紐づけて保持する{@link Map}
	 */
	private final Map<String, Method> attri = new HashMap<String, Method>();
	/*
	 * Static initializer.
	 */
	static {
	 ...
	 * メソッド情報をセットアップします。
	 * 
	 * @param accessDef 指定されたクラスのプロパティの{@code Map<String, OouoAccessInfo>}
	 */
	...
	/**
	 * 要素を示すオブジェクトに設定された振る舞いの値を参照して、 {@link OouoAccessInfo}オブジェクトに与える操作を振り分けます。
	 * 
	...
	/**
	 * 指定された{@link OouoAccessInfo}から取得した{@link OouoSig}情報を元に 指定された{@code
	 * Map<String, Map<String, Method>>}を更新します。
	 * <p>
	 ...
	 * @param tgtMap 要素と属性を紐づけて保持する{@link Map}
	 */
	private void attriEleImpl(OouoAccessInfo accessInfo, int eleType,
	        Map<String, Map<String, Method>> tgtMap) {
	 ...
	 */
	private void setupAccessInfoToMap(OouoAccessInfo accessInfo,
	        Map<String, Method> tgtMap) {
		OouoSig sig = (OouoSig) accessInfo.getSigSet().toArray()[0];
		String val = (String) FieldUtil.get(sig.getField(), tgtObj);
	...
	/**
	 * 指定された{@link OouoAccessInfo}の属性名がメソッド名として登録されているかどうかを判定し、 存在した場合はその対応した
	 * {@link Method}を返します。 対応するメソッドがなかった場合は{@code null}を返します。
	 * 
	...
	private Method getSetupMethod(OouoAccessInfo accessInfo) {
		...
		if (methodMap.containsKey(tgtName)) {
			tgtMethod = methodMap.get(tgtName);
		}
		return tgtMethod;
	}

	/**
	 * 指定されたクラスのプロパティの全てを{@code Map<String, OouoAccessInfo>}に 変換して返します。
	 * 
	 * @param clazz 変換したいクラス
	 * @return 指定されたクラスのプロパティの{@code Map<String, OouoAccessInfo>}
	 */
	private Map<String, OouoAccessInfo> setupAccessDef(Class<?> clazz) {
		Field field[] = clazz.getFields();
		Map<String, OouoAccessInfo> accessDef =
		    new HashMap<String, OouoAccessInfo>();
		for (Field tgt : field) {
	 ...
	 * <p>
	 * {@link Field}の{@code Name}と同じシグネチャを持つ{@link OouoSig}がなかった場合、{@code null}
	 * を返します。
	 * </p>
	 * 
	...
	/*
	 * @see
	 * org.escafe.buri.oouo.reader.OouoClassDef#isChildElement(java.lang.String)
	 */
	...
	/*
	 * @see
	 * org.escafe.buri.oouo.reader.OouoClassDef#getChildObject(java.lang.String)
	 */
	...
	private Method getSetterMethod(String name) {
		...
		if (childElement.containsKey(name)) {
			tgtMethod = childElement.get(name);
		}
		return tgtMethod;
	}
	...
	/*
	 * @see
	 * org.escafe.buri.oouo.reader.OouoClassDef#isChildAttribute(java.lang.String
	 * , java.lang.String)
	 */
	...
	/*
	 * @see
	 * org.escafe.buri.oouo.reader.OouoClassDef#setChildAttribute(java.lang.
	 * Object, java.lang.String, java.lang.String, java.lang.String)
	 */
	public void setChildAttribute(Object now, String name, String type,
	        String value) {
		Method tgtMethod = null;
		Map<String, Method> types = null;
		if (attriElement.containsKey(name)) {
	...
	/*
	 * @see
	 * org.escafe.buri.oouo.reader.OouoClassDef#isAttribute(java.lang.String)
	 */
	...
	/*
	 * @see
	 * org.escafe.buri.oouo.reader.OouoClassDef#setAttribute(java.lang.Object,
	...
	/*
	 * @see org.escafe.buri.oouo.reader.OouoClassDef#fin(java.lang.Object,
	 * java.lang.Object)
	 */
	...
	/*
	 * @see org.escafe.buri.oouo.reader.OouoClassDef#setText(java.lang.Object,
	 * java.lang.String)
	 */
