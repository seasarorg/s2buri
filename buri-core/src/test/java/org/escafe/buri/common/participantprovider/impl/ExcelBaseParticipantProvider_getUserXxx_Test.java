 ...
 */
public class ExcelBaseParticipantProvider_getUserXxx_Test extends S2DaoTestCase {
    ...
    public void testGetUserData() throws Exception {
        ...
        Object userDto = participantProvider.getUserData(new IdentityInfo(new Long(1), "ユーザ@ロールA"));
