...
public class BaoInvokerImpl implements BaoInvoker {
    ...
    public Object invoke(BaoInvokeMetadata invokeMetadata, MethodInvocation invoke) {
        ...
        Map<String, Object> appContext = getAppContext(invokeMetadata, invoke, null, null);
    ...
    protected Long countDataList(BaoStatusMetadata statusMetadata, MethodInvocation invoke) {
        ...
        Map<String, Object> appContext = getAppContext(statusMetadata, invoke, datas, "datas");
        return countByPathAndDatas(path, datas, userData, container.getRoot(), appContext);
    }

    protected Long countByPathAndDatas(String path, List datas, Object userData, S2Container container, Map<String, Object> appContext) {
    ...
    protected Map<String, Object> getAppContext(BaoFunctionMetadata invokeMetadata, MethodInvocation invoke, Object argData, String dataName) {
