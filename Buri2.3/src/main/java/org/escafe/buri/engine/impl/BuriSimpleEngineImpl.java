...
public class BuriSimpleEngineImpl extends WakanagoEngineImpl implements
	...
	/*
	 * @see org.escafe.buri.engine.BuriEngine#setupUserID(org.escafe.buri.engine.BuriSystemContext)
	 */
	public void setupUserID(BuriSystemContext sysContext) {
	}

	/*
	 * @see org.escafe.buri.engine.impl.WakanagoEngineImpl#readWorkFlowFromResource(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	...
	public void abortData(BuriSystemContext sysContext) {
		...
		stateDao.updateAbortByData(longKey, manyKey, accessUtil
				.getClassName(data));
	}

	/*
	 * @see org.escafe.buri.engine.impl.WakanagoEngineImpl#updateSystemContext(org.escafe.buri.engine.BuriSystemContext,
	...
	protected void updateSystemContext(BuriSystemContext sysContext,
		...
		BuriPathDataEntityDto dto = pathDataDao.getDtoByPathKey(accessUtil
				.getClassName(data), longKey, manyKey, pathName, sysContext
				.getCallPath().getPathType());
		// 最終的なセットアップを実施
	 ...
	 * 
	 * @param dto 更新対象の{@link BuriPathDataEntityDto}
	 * @param sysContext 更新時に参照する{@link BuriSystemContext}
	 */
	protected void finalSetup(BuriPathDataEntityDto dto,
			BuriSystemContext sysContext) {
		if (dto != null) {
			/*
			 * BuriPathDataEntityDtoがnullの場合
			 */
			sysContext.setDataID(new Long(dto.getDataID()));
			sysContext.setStatusID(new Long(dto.getStateID()));
			BuriPath callPath = new BuriPath(dto.getPathName(), dto
					.getRealPathName(), dto.getPathID(), dto.getPathType());
	...
	protected void preprocessData(BuriDataAccessFactory factory,
		...
		PreprocessAccessUtil pre = factory.getPreprocessAccessUtil(userContext
				.getData().getClass());
		if (pre != null) {
	 ...
	 * </p>
	 * 
	 * @param pathDataDao ぶり固有のビュー{@code BuriPathData}のDao
	 */
	...
	/*
	 * @see org.escafe.buri.engine.impl.WakanagoEngineImpl#setBuriCompiler(org.escafe.buri.compiler.BuriCompiler)
	 */
	@Override
