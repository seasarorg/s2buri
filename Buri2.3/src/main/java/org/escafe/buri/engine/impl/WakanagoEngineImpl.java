 ...
 * ぶりの中核を担うエンジンの実装です。
 * <p>
 * {@link WakanagoEngine}の実装として、
 * {@link BuriSimpleEngineImpl}と{@link BuriStandardEngineImpl}に基底の実装を提供しています。
 * </p>
 * 
 * @author makotan
 * @author nobeans
...
public class WakanagoEngineImpl implements WakanagoEngine {
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#readWorkFlowFromResource(java.lang.String,
     *      java.lang.String)
     */
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#readWorkFlowFromInputStream(java.io.InputStream,
     *      java.lang.String)
     */
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#readWorkFlowFromBuriPackageType(org.escafe.buri.oouo.internal.structure.BuriPackageType,
     *      java.lang.String)
     */
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#hasPackage(java.lang.String)
     */
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#createUserContext(java.lang.Object,
     *      java.lang.Object, java.lang.Object, java.util.Map)
     */
    public BuriUserContext createUserContext(Object data, Object userData, Object action, Map<String, Object> addContext) {
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#createSystemContext(java.lang.String,
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#execute(org.escafe.buri.engine.BuriSystemContext,
     *      java.lang.String)
     */
    ...
    /**
     * TODO 確証持てず 実施後のアクティビティのIDを取得します。
     * 
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#selectDirectProcess(org.escafe.buri.engine.BuriPath)
     */
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#selectProcess(org.escafe.buri.util.packages.BuriExePackages,
    ...
    public BuriExecProcess selectProcess(BuriExePackages wPackageObj, BuriSystemContext sysContext) {
        ...
        List<BuriWorkflowProcessType> pros = new ArrayList<BuriWorkflowProcessType>();
     ...
     */
    protected BuriExecProcess selectProcessFinal(List<BuriWorkflowProcessType> pros, BuriSystemContext systemContext, BuriExePackages wPackageObj) {
        if (pros.size() != 1) {
     ...
     * @param wPackageObj {@link BuriExePackages}
     */
    protected void errorProcessSelect(List<BuriWorkflowProcessType> proces, BuriSystemContext systemContext, BuriExePackages wPackageObj) {
        BuriPath callPath = systemContext.getCallPath();
        String pakageID = callPath.getWorkflowPackage();
        // エラー発生時の追加処理を実施
    ...
    /*
     * @see org.escafe.buri.engine.WakanagoEngine#selectPackage(org.escafe.buri.engine.BuriSystemContext)
     */
    ...
    /**
     * 実行対象の{@link BuriPath}に合致する{@link BuriWorkflowProcessType}の
     * リストを検索して返します。
     * 
    ...
    protected List<BuriWorkflowProcessType> getProcessList(BuriPath path) {
        ...
        List<BuriWorkflowProcessType> processList = (List<BuriWorkflowProcessType>) wPackageObj.getBuriPackageType().getProcessByName(path.getWorkflowProcess());
        return processList;
    }
     ...
     */
    public void setBuriActivitySelectEventCaller(BuriActivitySelectEventCaller buriActivitySelectEventCaller) {
     ...
     */
    public void setBuriProcessSelectEventCaller(BuriProcessSelectEventCaller buriProcessSelectEventCaller) {
