 ...
 *
 */
package org.escafe.buri.path.wakanago;
...
import org.escafe.buri.path.BuriPathSelectUtil;
...
public class WakanagoBuriPathSelectUtilImpl implements BuriPathSelectUtil {
    ...
    protected List getProcessToActivityNameList(String pathName, BuriWorkflowProcessType process, List activityList, int pos,
