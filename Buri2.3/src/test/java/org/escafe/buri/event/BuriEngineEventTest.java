...
public class BuriEngineEventTest extends S2TestCase {
    ...
    public void testEventTx() {
    	...
    	activitySelectEventCaller.addEventListener(new BuriActivitySelectEventListener() {
    	...
    	processSelectEventCaller.addEventListener(new BuriProcessSelectEventListener() {
