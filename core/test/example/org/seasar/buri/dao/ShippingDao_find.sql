...
where
	...
	/*IF dto.shippingDate != null*/AND shippingDate = /*dto.shippingDate*/'2005-01-01 00:00:00.0000'/*END*/
	/*IF dto.shippingDate_not != null*/AND shippingDate != /*dto.shippingDate_not*/'2005-01-01 00:00:00.0000'/*END*/
	/*IF dto.shippingDate_large != null*/AND  /*dto.shippingDate_large*/'2005-01-01 00:00:00.0000' < shippingDate/*END*/
	/*IF dto.shippingDate_moreLarge != null*/AND  /*dto.shippingDate_moreLarge*/'2005-01-01 00:00:00.0000' <= shippingDate/*END*/
	/*IF dto.shippingDate_from != null*/AND  /*dto.shippingDate_from*/'2005-01-01 00:00:00.0000' <= shippingDate/*END*/
	/*IF dto.shippingDate_to != null*/AND shippingDate <= /*dto.shippingDate_to*/'2005-01-01 00:00:00.0000'/*END*/
	/*IF dto.shippingDate_moreSmall != null*/AND shippingDate <= /*dto.shippingDate_moreSmall*/'2005-01-01 00:00:00.0000'/*END*/
	/*IF dto.shippingDate_small != null*/AND shippingDate < /*dto.shippingDate_small*/'2005-01-01 00:00:00.0000'/*END*/
	...
	/*IF dto.shippingDate_in != null*/AND shippingDate in /*dto.shippingDate_in*/('2005-01-01 00:00:00.0000')/*END*/
	...
	/*IF keys != null*/AND shippingID in /*keys*/(0) /*END*/
