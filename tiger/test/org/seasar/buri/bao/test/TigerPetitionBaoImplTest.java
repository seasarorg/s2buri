...
import org.seasar.buri.bao.PurePetitionBao;
...
public class TigerPetitionBaoImplTest extends S2TestCase {
    private static Logger logger = Logger.getLogger(TigerPetitionBaoImplTest.class);
    private BuriEngine buriEngine_;
    private PurePetitionBao petitionBao_;
    ...
    public TigerPetitionBaoImplTest(String arg0) {
        super(arg0);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        include("org/seasar/buri/bao/test/dicon/TigerPetitionImpl.dicon");
    }
